            ...
            VStack {
                ...
                List {
                    ...
                    ForEach(allTasks) { task in
                        HStack {
                            Image(systemName: task.isFavorite ? "circle.circle.fill": "circle")
                                .foregroundColor(.blue)
                                .onTapGesture {
                                    updateTask(task)
                                }
                            Image(systemName: task.isFavorite ? "exclamationmark": "exclamationmark.2")
                                .foregroundColor(styleForPriority(task.priority!))
